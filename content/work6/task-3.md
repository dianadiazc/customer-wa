...
1. In this task you will use the new **Dataset** to create four visuals from the Cost and Usage Report (CUR) data. From the dataset, we will use the following fields (or columns of data):
...
1. You will use two fields from the CUR dataset

	* line_item_blended_cost

	* product_servicecode

1. Scroll down the **Fields list** until you find `line_item_blended_cost` and click on the field to add it to the graph. Optionally you could type the field name in the Fields search box.

    <img src="../images/qs-addblendedcost.png" alt="drawing" width="300"/>

1. You will see the monthly total expenditure in the account in the graph.

    <img src="../images/qs-blendedcostingraph.png" alt="drawing" width="700"/>

1. Now add the field `product_servicecode`. You could scroll the list or type it in the search box. This is the expected updated graph view.
...
1. Now you will create a visual to show the monthly cost per EC2 instance, you will use this fields from the CUR dataset:
...
1. From the top left of your browser, click on **+ Add**, from the drop down menu click on **Add visual**

    <img src="../images/qs-addvisual.png" alt="drawing" width="300"/>

1. You will see a new blank graph added.

    {{% notice warning %}}
Make sure the graph you are working on is selected, it should be highlighted with blue border lines
{{% /notice %}}

1. From the fields list, search and click on `line_item_blended_cost` to add it to the graph.

1. Add a second field to the graph, search and click `line_item_resource_id` to add the field to the graph

1. You will see a graph will **all** the resources in the account and their monthly cost, to narrow the information displayed you will use **Filters**, so you can visualize only the data you are interested in.
...
1. From the left menu, click on **Filter**, then click on **Create one...**.

    <img src="../images/qs-addfilter.png" alt="drawing" width="280"/>

1. From the menu displayed type `line_item_line_item_type` in the search box.

    <img src="../images/qs-typefilter.png" alt="drawing" width="280"/>

1. Click on the **Field** displayed.

1. Below the **Filters** options, click on the filter you just added.
...
1. Click **Apply** at the buttom.

1. Now click on **Exit filter edit**

    <img src="../images/qs-exitfilteredit.png" alt="drawing" width="350"/>

1. Now you will create a second filter, click the plus sign next to **Filters**.

    <img src="../images/qs-addfilter2.png" alt="drawing" width="280"/>

1. From the filters menu, type `line_item_usage_type` in the search box.

1. Click on the filter displayed.

1. Click on the filter you just created.

    <img src="../images/qs-secondfilter1.png" alt="drawing" width="280"/>

1. From the values displayed, click on **Select all** to DE-SELECT all values.

1. Select just **BoxUsage:t2.large** and **BoxUsage:t3.xlarge**

    <img src="../images/qs-justboxusage.png" alt="drawing" width="220"/>

1. Click **Apply**

1. You will see the graph will be updated just showing cost data from three EC2 instances.

1. For better visualization now you will change the graph visualization type. From the left menu, click on **Visualize**

1. Under **Visual types**, click on the *donut chart* option.

    <img src="../images/qs-donut.png" alt="drawing" width="280"/>

1. You will notice how the graph is updated.
...
1. You will now create a visual with amount of money saved by the customer's Savings Plan. You will use this fields from the CUR dataset:
...
1. From the *Fields list*, select and click on `line_item_blended_cost` to add it to the graph

1. You will see the amount of expense for all the AWS services consumed in the account, to get the savings amount you need to narrow your search adding a filter. From the left menu, click on **Filter**, then click on **Create one...**.
...
1. From the Filter options displayed, click on **Select all** to DE-SELECT all the options and just mark the **SavingsPlanNegation** and **SavingsPlanRecurringFee** checkboxes.

    <img src="../images/qs-savings-filter1.png" alt="drawing" width="280"/>

1. Click **Apply** at the buttom. You have created a visualization with the monthly Savings Plan savings in the account.
...
1. You could change the value format, from left panel click on **Visualize** and below **Fields list** type `line_item_blended_cost`, move your mouse over the field displayed and three dots will show up, click on them...

    <img src="../images/qs-change-value-type.png" alt="drawing" width="280"/>

1. Click on **Show as: Number**, then click on **Currency**

    <img src="../images/qs-set-currency.png" alt="drawing" width="450"/>

    #### Visual #4: Monthly expense per EBS volume type

1. You will now create a visual with the monthly expense on EBS volumes, per volume type. To create this visualization you will use this fields
...
1. From the *Fields list*, select and click on `line_item_blended_cost` to add it to the graph. You could scroll down the list or type it in the search box.

1. Now also add to the graph the field `line_item_usage_type` from the *Fields list*.

1. You will get this graph.

    <img src="../images/qs-graph4-pre.png" alt="drawing" width="400"/>

1. You have to narrow the items listed with a filter to just show the EBS volume usage types. From the left menu, click on **Filter**, then click on **Create one...**.

1. From the menu displayed, type `line_item_usage_type` in the search box.

1. Click on the **Field** displayed.

1. Below the **Filters** options, click on the filter you just added.

1. From the Filter options displayed, click on **Select all** to DE-SELECT all the options and just mark the **EBS:VolumeUsage.sc1**, **EBS:VolumeUsage.gp2** and **EBS:VolumeUsage** checkboxes.

    Note: **EBS:VolumeUsage** refers to the previous generation HDD EBS volume.

1. Click **Apply** at the buttom to update the graph

1. For better visualization now you will change the graph visualization type. From the left menu, click on **Visualize**

1. Under **Visual types**, click on the *pie chart* option.
...
1. Finally you could change the graph labels to better identify the information displayed. On each graph click on the *titles* to change them.
