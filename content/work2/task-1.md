...
{{% notice warning %}}
Probably, you will see an additional EC2 instance **wa-glue-server**. This instance is used as part of the Lab 5 setup and it will be automatically terminated before you finish Lab 1. **You do not need to take actions with this instance.**
{{% /notice %}}
